...
class OracleStorage {
  ...
  /* createBucket method creates a new bucket in the Object Storage service.
    ...
    Returns:
      - Message that the bucket is created successfully
    Error:
  ...
  */
  ...
  /* DeleteBucket method deletes a bucket from the Object Storage service.
    ...
    Returns:
      - Message that the bucket is deleted
    Errors:
    - Bucket not empty
    - Bucket not found or failed to delete bucket
  */
  ...
  /* createObj method uploads an object to the Object Storage service.
    ...
    Returns:
      - Message that the object is created
    Errors:
  ...
  */
  ...
  Returns:
    - list of names of the objects in the bucket
  Errors:
  ...
  */
  async getAllObj(bucketName) {
    try {
      ...
      const ListOfObjects = result.listObjects.objects.map((object) => object.name);
  ...
  /* delete method deletes an object from the Object Storage service.
    ...
    Returns:
      - Message that the object is deleted
    Errors:
